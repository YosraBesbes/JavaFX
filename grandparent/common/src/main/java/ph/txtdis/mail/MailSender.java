...
public class MailSender {
    ...
    public void generateAndSendEmail(String[] toEmails, String subject, String body, String file)
    ...
    private void setMimeMessageAddresses(String[] toEmails) throws MessagingException, UnsupportedEncodingException,
            AddressException {
    ...
    private InternetAddress[] getAddresses(String[] toEmails) throws MessagingException {
    ...
    private void setMessageContent(String subject, String body, String file) throws MessagingException {
    ...
    private Multipart setMultipart(BodyPart bodyPart, MimeBodyPart attachment) throws MessagingException {
    ...
    private MimeBodyPart setAttachment(String file) throws MessagingException {
