...
public class PersistenceConfiguration {
    ...
    private void start() {
        ...
        Users sysgen = userRepository.save(new Users("SYSGEN", encode("I'mSysGen4txtDIS@PostgreSQL"), true));
        groupRepository.save(new Authorities(sysgen, "ROLE_USER"));

        Users txtdis = new Users("TXTDIS", encode("txtDIS@1"), true);
        txtdis.setEmail("txtdis.mgdc.edsa.dmpi@gmail.com");
        userRepository.save(txtdis);
        groupRepository.save(new Authorities(txtdis, "ROLE_MANAGER"));

        Users jackie = new Users("JACKIE", encode("robbie"), true);
        jackie.setEmail("manila12@gmail.com");
        jackie.setType(UserType.MANAGER);
        userRepository.save(jackie);
        groupRepository.save(new Authorities(jackie, "ROLE_MANAGER"));

        Users ronald = new Users("RONALD", encode("alphacowboy"), true);
        ronald.setEmail("ronaldallanso@yahoo.com");
        ronald.setType(UserType.MANAGER);
        userRepository.save(ronald);
        groupRepository.save(new Authorities(ronald, "ROLE_MANAGER"));

        Users butch = new Users("BUTCH", encode("attila"), true);
        butch.setEmail("butchlim888@yahoo.com");
        butch.setType(UserType.MANAGER);
        userRepository.save(butch);
        groupRepository.save(new Authorities(butch, "ROLE_MANAGER"));

        userRepository.save(new Users("MICHELLE", encode("TWEETY"), true));
        userRepository.save(new Users("ANGIE", encode("Angelica"), true));
        userRepository.save(new Users("MAY", encode("May"), true));
        userRepository.save(new Users("MENNEN", encode("Mennen"), true));
        userRepository.save(new Users("MHON", encode("NOMAR"), true));
        userRepository.save(new Users("IRENE", encode("magnum08"), true));

        userRepository.save(new Users("OGIE", encode("dsp"), true));
        userRepository.save(new Users("PHILLIP", encode("dsp"), true));
        userRepository.save(new Users("BONG", encode("dsp"), true));
        userRepository.save(new Users("RANDY", encode("dsp"), true));
        userRepository.save(new Users("ROBERT", encode("dsp"), true));
        userRepository.save(new Users("HENRY", encode("dsp"), true));
        userRepository.save(new Users("ROLAND", encode("dsp"), true));

        truckRepository.save(new Truck("RDM801"));
        truckRepository.save(new Truck("KDL170"));
        truckRepository.save(new Truck("WSN519"));

        routeRepository.save(new Route("S41"));
        routeRepository.save(new Route("S42"));
        routeRepository.save(new Route("S43"));
        routeRepository.save(new Route("S44"));
        routeRepository.save(new Route("S45"));
        routeRepository.save(new Route("PMS1"));
        routeRepository.save(new Route("PMS2"));
        routeRepository.save(new Route("PMS3"));

        userRepository.save(new Users("LARRY", encode("dsp"), true));
        userRepository.save(new Users("VICENTE", encode("dsp"), true));
        Users noli = userRepository.save(new Users("NOLI", encode("dsp"), true));
        groupRepository.save(new Authorities(noli, "ROLE_USER"));

        userRepository.save(new Users("MARK", encode("dsp"), true));
        userRepository.save(new Users("MICHAEL", encode("dsp"), true));
        userRepository.save(new Users("TATA", encode("dsp"), true));
        userRepository.save(new Users("KEVIN", encode("dsp"), true));
        userRepository.save(new Users("JEFF", encode("dsp"), true));
        userRepository.save(new Users("RENE", encode("dsp"), true));
        ...
        familyRepository.save(new ItemFamily("SOLIDS", ItemTier.CATEGORY));
        ...
        qualityRepository.save(new Quality("GOOD"));
        qualityRepository.save(new Quality("HOLD"));
        qualityRepository.save(new Quality("BAD"));

        warehouseRepository.save(new Warehouse("EDSA"));
        ...
        Item pineSliceFlat = new Item("PINE SLCE FLT 227G", "DEL MONTE SLICED PINEAPPLE FLAT 227G X 24",
                ItemType.PURCHASED);
        pineSliceFlat.setFamily(familyRepository.findOne(13));
        ...
        itemRepository.save(pineSlice15);

        Users dsp1 = userRepository.findOne("OGIE");
        Users dsp2 = userRepository.findOne("PHILLIP");
        Users dsp3 = userRepository.findOne("BONG");
        Users dsp4 = userRepository.findOne("RANDY");
        Users dsp5 = userRepository.findOne("ROBERT");
        Users dsp6 = userRepository.findOne("HENRY");
        Users dsp7 = userRepository.findOne("ROLAND");

        Route s41 = routeRepository.findOneByName("S41");
        Route s42 = routeRepository.findOneByName("S42");
        Route s43 = routeRepository.findOneByName("S43");
        Route s44 = routeRepository.findOneByName("S44");
        Route pms1 = routeRepository.findOneByName("PMS1");
        Route pms2 = routeRepository.findOneByName("PMS2");
        Route pms3 = routeRepository.findOneByName("PMS3");

        accountRepository.save(new Account(dsp1, s41, startDate));
        accountRepository.save(new Account(dsp2, s42, startDate));
        accountRepository.save(new Account(dsp3, s43, startDate));
        accountRepository.save(new Account(dsp4, s44, startDate));
        accountRepository.save(new Account(dsp5, pms1, startDate));
        accountRepository.save(new Account(dsp6, pms2, startDate));
        accountRepository.save(new Account(dsp7, pms3, startDate));
        ...
        Location saint_martin_de_porres = locationRepository.save(new Location("SAINT MARTIN DE PORRES",
        ...
        Location santo_niño = locationRepository.save(new Location("SANTO NIÑO", LocationType.BARANGAY));
        ...
        Location caa_bf_international = locationRepository.save(new Location("CAA-BF INTERNATIONAL",
                LocationType.BARANGAY));
        ...
        Location dasmariñas = locationRepository.save(new Location("DASMARIÑAS", LocationType.BARANGAY));
        ...
        Location post_proper_northside = locationRepository.save(new Location("POST PROPER NORTHSIDE",
                LocationType.BARANGAY));
        Location post_proper_southside = locationRepository.save(new Location("POST PROPER SOUTHSIDE",
                LocationType.BARANGAY));
        ...
        Location tañong = locationRepository.save(new Location("TAÑONG", LocationType.BARANGAY));
        ...
        Location new_zañiga = locationRepository.save(new Location("NEW ZAÑIGA", LocationType.BARANGAY));
        Location old_zañiga = locationRepository.save(new Location("OLD ZAÑIGA", LocationType.BARANGAY));
        ...
        Location wack_wack_greenhills = locationRepository.save(new Location("WACK-WACK GREENHILLS",
                LocationType.BARANGAY));
        ...
        Location northbay_boulevard_north = locationRepository.save(new Location("NORTHBAY BOULEVARD NORTH",
                LocationType.BARANGAY));
        Location northbay_boulevard_south = locationRepository.save(new Location("NORTHBAY BOULEVARD SOUTH",
                LocationType.BARANGAY));
        Location northbay_boulevard_south_1 = locationRepository.save(new Location("NORTHBAY BOULEVARD SOUTH 1",
                LocationType.BARANGAY));
        Location northbay_boulevard_south_2 = locationRepository.save(new Location("NORTHBAY BOULEVARD SOUTH 2",
                LocationType.BARANGAY));
        Location northbay_boulevard_south_3 = locationRepository.save(new Location("NORTHBAY BOULEVARD SOUTH 3",
                LocationType.BARANGAY));
        ...
        Location san_martin_de_porres = locationRepository.save(new Location("SAN MARTIN DE PORRES",
                LocationType.BARANGAY));
        ...
        Location manila_bay_reclamation = locationRepository.save(new Location("MANILA BAY RECLAMATION",
                LocationType.BARANGAY));
        ...
        Location santo_rosario_kanluran = locationRepository.save(new Location("SANTO ROSARIO KANLURAN",
                LocationType.BARANGAY));
        Location santo_rosario_silangan = locationRepository.save(new Location("SANTO ROSARIO SILANGAN",
                LocationType.BARANGAY));
        ...
        Location bagong_lipunan_ng_crame = locationRepository.save(new Location("BAGONG LIPUNAN NG CRAME",
                LocationType.BARANGAY));
        ...
        Location doña_aurora = locationRepository.save(new Location("DOÑA AURORA", LocationType.BARANGAY));
        Location doña_imelda = locationRepository.save(new Location("DOÑA IMELDA", LocationType.BARANGAY));
        Location doña_josefa = locationRepository.save(new Location("DOÑA JOSEFA", LocationType.BARANGAY));
        ...
        Location immaculate_concepcion = locationRepository.save(new Location("IMMACULATE CONCEPCION",
                LocationType.BARANGAY));
        ...
        Location san_isidro_labrador = locationRepository.save(new Location("SAN ISIDRO LABRADOR",
                LocationType.BARANGAY));
        ...
        Location ermitaño = locationRepository.save(new Location("ERMITAÑO", LocationType.BARANGAY));
        ...
        Location central_signal_village = locationRepository.save(new Location("CENTRAL SIGNAL VILLAGE",
                LocationType.BARANGAY));
        ...
        Location north_signal_village = locationRepository.save(new Location("NORTH SIGNAL VILLAGE",
                LocationType.BARANGAY));
        ...
        Location south_signal_village = locationRepository.save(new Location("SOUTH SIGNAL VILLAGE",
                LocationType.BARANGAY));
        ...
        Location las_piñas = locationRepository.save(new Location("LAS PIÑAS", LocationType.CITY));
        ...
        Location parañaque = locationRepository.save(new Location("PARAÑAQUE", LocationType.CITY));
        ...
        sarisari.setChannel(channelRepository.findOne(2));
        ...
        palengke.setChannel(channelRepository.findOne(3));
        ...
        variety.setChannel(channelRepository.findOne(2));
        ...
        wetStall.setChannel(channelRepository.findOne(3));
        ...
        dryStall.setChannel(channelRepository.findOne(4));
        ...
        BigDecimal price = pricingRepository.findFirstByItemAndTypeAndStartDateLessThanEqualOrderByStartDateDesc(
                pineSliceFlat, PricingType.PURCHASE, date).getPrice();
        BigDecimal pricePerCS = price.multiply(getQtyPerUomMap(1).get(UomType.CS));
