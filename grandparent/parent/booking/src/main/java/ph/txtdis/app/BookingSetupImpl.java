...
public class BookingSetupImpl implements BookingSetup {
    ...
    public void start() {
        ...
        BookingDetail sarisariDetail = new BookingDetail(sarisariBooking, item, UomType.PC, sarisariQty);
        ...
        BookingDetail palengkeDetail = new BookingDetail(palengkeBooking, item, UomType.CS, palengkeQty);
        ...
        BookingDetail varietyDetail = new BookingDetail(varietyBooking, item, UomType.PC, varietyQty);
        ...
        BookingDetail wetMarketDetail = new BookingDetail(wetMarketBooking, item, UomType.PC, wetMarketQty);
        ...
        BookingDetail dryMarketDetail = new BookingDetail(dryMarketBooking, item, UomType.CS, dryMarketQty);
