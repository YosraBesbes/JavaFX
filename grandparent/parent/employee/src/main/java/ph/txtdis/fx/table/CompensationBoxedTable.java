...
public class CompensationBoxedTable extends AbstractBoxedTable<Compensation, EmployeeDTO> {
    ...
    protected void addTableColumns() {
        ...
        TableColumn<Compensation, LocalDate> startCol = FX.addDateColumn("Start", "startDate");
        TableColumn<Compensation, BigDecimal> dailyRateCol = FX.addPriceColumn("Daily Rate", "dailyRate");
