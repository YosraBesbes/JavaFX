...
public class PersonalTab extends AbstractTab<EmployeeDTO> {
    ...
    private StringField surnameField, nameField, middleInitialField, birthplaceField, emergencyContactField,
            emergencyPhoneField;

    public PersonalTab(Stage stage, EmployeeDTO dto) {
        super("Personal", "personal", stage, dto);
    }
    ...
    protected Node[] addNodes(Stage stage, EmployeeDTO dto) {
        ...
        civilStatusCombo = FX.createComboBox(CivilStatus.values(), dto.getCivilStatus());
        ...
        emergencyRelationCombo = FX.createComboBox(FamilyType.values(), dto.getEmergencyRelation());
